...
if !exists("g:formatprg_args_expr_cs") && !exists("g:formatprg_args_cs")
    let g:formatprg_args_expr_cs = '"--mode=cs --style=java --indent-namespaces -pcH".(&expandtab ? "s".&shiftwidth : "t")'
endif
...
if !exists("g:formatprg_args_expr_cpp")  && !exists("g:formatprg_args_cpp")
    let g:formatprg_args_expr_cpp = '"--mode=c --style=java -pcH".(&expandtab ? "s".&shiftwidth : "t")'
endif
...
if !exists("g:formatprg_ruby") | let g:formatprg_json = "ruby_beautifier" | endif
if !exists("g:formatprg_args_expr_ruby") && !exists("g:formatprg_args_ruby")
    let g:formatprg_args_expr_ruby = '"- "'
endif
